   ...
   //// $diagnosis=$row['diagnosis'];
    ...
    echo' <tr>
            <th scope="row">'.$idn.'</th>
                      ...
                      <td>'.$diagnosis.'</td>
                       <td>'.$address.'</td>
                       <td style="width: 50px;">'.$r1.'</td>
                       <td style="width: 50px;">'.$r2.'</td>
                       <td style="width: 50px;">'.$r3.'</td>
                       <td style="width: 50px;">'.$r4.'</td>
                       <td style="width: 50px;">'.$r5.'</td>
                       <td style="width: 50px;">'.$r6.'</td>
                       <td style="width: 50px;">'.$r7.'</td>
                       <td style="width: 50px;">'.$r8.'</td>
                       <td style="width: 50px;">'.$r9.'</td>
                       <td style="width: 50px;">'.$r10.'</td>
                      <td style="width: 50px;">'.$r11.'</td>
   ...
   //// $diagnosis=$row['diagnosis'];
    ...
    echo' <tr>
            <th scope="row">'.$idn.'</th>
                      ...
                      <td >'.$diagnosis.'</td>
                       <td >'.$address.'</td>
                       <td style="width: 50px;">'.$h1.'</td>
                       <td style="width: 50px;">'.$h2.'</td>
                       <td style="width: 50px;">'.$h3.'</td>
                       <td style="width: 50px;">'.$h4.'</td>
                       <td style="width: 50px;">'.$h5.'</td>
                       <td style="width: 50px;">'.$h6.'</td>
                       <td style="width: 50px;">'.$h7.'</td>
                       <td style="width: 50px;">'.$h8.'</td>
                       <td style="width: 50px;">'.$h9.'</td>
                       <td style="width: 50px;">'.$h10.'</td>
                      <td style="width: 50px;">'.$h11.'</td>
