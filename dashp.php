...
<br>
    ...
    <button  style="width:100px; background-color:azure; margin-left:50px; border-radius:10px;">
     <a href="fetchp77.php" style="color:blue; text-decoration:none;"><b>edit-profile</b></a></button><br>
    <button  style="width:100px; background-color:azure; margin-left:50px; border-radius:10px;">

    <a href="regpat1.php" style="color:blue;text-decoration:none"><b> patient-register</b></a></button><br>
    <button  style="width:100px; background-color:azure; margin-left:50px; border-radius:10px;">
    <a href="under.php" style="color:blue;text-decoration:none"><b>last diagnosis </b></a></button><br>
    
    <button  style="width:100px; background-color:azure; margin-left:50px; border-radius:10px;"> 
     <a href=""style="color:blue;text-decoration:none"><b>patient status</b></a></button><br>
    <button  style="width:100px; background-color:azure; margin-left:50px; border-radius:10px;"> 
