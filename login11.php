...
if($_SERVER['REQUEST_METHOD'] =="POST") {
  include("database.php");
   ...
   //$username=$_POST['username'];
    ...
    $sql="Select * from admin where F_name='$F_name' and  password='$password'";
...
if($F_name=="mercy" && $password=="wow") {
    header("Location:dashte.php");
}
else if($F_name=="metages" && $password=="wow") {
    header("Location:dasha.php");
}
else if($F_name=="mekuanint" && $password=="wow") {
 header("Location:dasha.php");
}
else if($F_name=="yordanos" && $password=="wow") {
  header("Location:dashd.php");
}
 else if($F_name=="sami" && $password=="wow") {
...
else if($F_name=="alazar" && $password=="winwin") {
   header("Location:dashd.php");
 }
