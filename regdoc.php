...
<head>
    ...
    <style type="text/css">
      ...
      body{
         ...
         background-image: url("pim/22.png"); 
...
<h2 style=" margin-left:120px;">Doctor sign up</h2 >
<form action="#">
   ...
   <div class="input-cnt">
      <i class="material-icons">specialization</i>
...
if($_SERVER['REQUEST_METHOD'] =="POST") {
    ...
    $sql="INSERT INTO doctor(F_name , L_name, specialization, email, address, age, gender, password,confirm )                /**sql   code  insert */                
